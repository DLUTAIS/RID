...
class ResNet(nn.Module):
    ...
    def __init__(self, depth, num_filters, block_name='BasicBlock', num_classes=14):
        ...
        # 维度改这里
        # self.fc1 = nn.Linear(3136, num_filters[3] * block.expansion)
...
def build_resnet_backbone(depth=20, num_classes = 14):
    if depth == 20:
...
def build_resnetx4_backbone(depth=20, num_classes = 14):
    if depth == 8:
