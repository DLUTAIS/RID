...
if 'x4' in args.teacher:
    ...
    # teacher = models.shufflenetv2().cuda()
    # import model.mobilenetv2 as models
    # teacher = models.mobilenetv2().cuda()
    # import model.vgg as models
    # teacher = models.vgg11_bn().cuda()
...
if teacher is not None:
    ...
    cnn = ResNet18(num_classes=num_classesnum_classes)
    ...
    # import model.shufflenetv2_new1 as models
    # cnn = models.shufflenetv2().cuda()
    # import model.mobilenetv2 as models
    # cnn = models.mobilenetv2().cuda()
    # import model.vgg as models
    # cnn = models.vgg11_bn().cuda()
...
# cnn_optimizer = torch.optim.Adam(trainable_parameters.parameters(), lr=args.lr, weight_decay=wd)
